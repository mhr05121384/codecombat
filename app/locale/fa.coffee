module.exports = nativeDescription: "فارسی", englishDescription: "Persian", translation:
  ...
  new_home:
#    title: "CodeCombat - یادگیری جاوا و پایتون برای کدنویسی بازی ها"
#    meta_keywords: "CodeCombat, پایتون, جاوا اسکرپت, کدنویسی برای بازی"
#    meta_description: "Learn typed code through a programming game. پایتون یاد بگیر, جاوا اسکریپت, as you solve puzzles and learn to make your own coding games and websites."
...
#    built_for_teachers_subtitle1: "علم کامپیوتر"
...
#    built_for_teachers_subtitle2: "سازنده بازی"
...
#  tournament:
#    mini_tournaments: "مسابقه کوچک"
#    usable_ladders: "All Usable Ladders"
#    make_tournament: "ساخت مسابقه کوچک"
#    go_tournaments: "رفتن به مسابقه کوچک"
#    class_tournaments: "Class mini tournaments"
#    no_tournaments_owner: "در حال حاضر هیچ مسابقه ای وجود ندارد, لطفا یکی بساز"
#    no_tournaments: "There is no tournament now"
#    edit_tournament: "ویرایش مسابقه"
#    create_tournament: "ساخت مسابقه"
